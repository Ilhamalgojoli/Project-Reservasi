    ...
    <form id="non-akademik" class="space-y-8">
        ...
        <div class="flex justify-center pt-4">
            <button type="button"
                ...
                "
                class="group flex items-center gap-3 px-10 py-3.5 bg-gradient-to-r from-[#e51411] to-[#ff3b38] text-white 
                rounded-xl font-bold shadow-lg shadow-red-200 hover:shadow-red-300 hover:-translate-y-0.5 
