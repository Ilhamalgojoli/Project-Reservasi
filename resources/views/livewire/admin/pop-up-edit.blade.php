<section class="popup fixed inset-0 bg-gray-900/80 flex items-center justify-center z-[100] p-4 transition-all duration-500">
    <div class="bg-white w-full max-w-2xl rounded-[8px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] overflow-hidden relative animate-slide-up">
        ...
        <div class="p-8 flex items-center justify-between bg-white border-b border-gray-100">
            ...
            <button type="button" wire:click="closeButton" class="w-12 h-12 flex items-center justify-center rounded-[8px] bg-gray-50 text-gray-400 border border-gray-100 hover:bg-red-50 hover:text-red-500 transition-all duration-300">
        ...
        <form wire:submit.prevent="submit">
            <div class="p-8 flex flex-col gap-8 max-h-[65vh] overflow-y-auto custom-scrollbar">
                        ...
                        <div class="flex flex-row gap-5">
                            ...
                            <div class="flex-1 space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <select wire:model="status" class="w-full pl-11 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium text-gray-800 focus:bg-white focus:ring-4 focus:ring-[#e51411]/5 focus:border-[#e51411] transition-all outline-none cursor-pointer">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between px-5 py-3 bg-gray-50 rounded-[8px] border border-gray-100">
            ...
            <div class="p-8 bg-gray-50/50 border-t border-gray-100">
                <div class="flex flex-row gap-4">
                    <button type="button" wire:click="$dispatch('confirmDeleteGedung', { id: {{ $id }}})" class="flex items-center justify-center gap-2 px-8 py-5 bg-gray-100 text-gray-400 rounded-[8px] font-black text-xs uppercase tracking-[0.2em] hover:bg-red-50 hover:text-red-500 transition-all border border-gray-200">
                        <iconify-icon icon="solar:trash-bin-trash-bold" class="text-xl"></iconify-icon>
                        Hapus
                    </button>
                    <button type="submit" class="flex-1 flex items-center justify-center gap-3 px-12 py-5 bg-[#e51411] text-white rounded-[8px] font-black text-xs uppercase tracking-[0.25em] hover:bg-red-700 hover:-translate-y-1 transition-all shadow-xl">
