<section class="popup fixed inset-0 bg-gray-900/80 flex items-center justify-center z-[100] p-4 transition-all duration-500">
    <div class="bg-white w-full max-w-2xl rounded-[8px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] overflow-hidden relative animate-slide-up border border-white/20 flex flex-col max-h-[90vh]">
        ...
        <form wire:submit.prevent="submit" class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="p-8 bg-gray-50/50 border-t border-gray-100 shrink-0">
                <div class="flex flex-row gap-4">
                    <button type="button" wire:click="$dispatch('confirmDeleteGedung', { id: {{ $id }}})" class="flex items-center justify-center gap-2 px-4 py-3.5 sm:px-8 sm:py-5 bg-gray-100 text-gray-400 rounded-[8px] font-black text-xs uppercase tracking-[0.2em] hover:bg-red-50 hover:text-red-500 transition-all border border-gray-200">
                        <iconify-icon icon="solar:trash-bin-trash-bold" class="text-xl"></iconify-icon>
                        Hapus
                    </button>
                    <button type="submit" class="flex-1 flex items-center justify-center gap-3 px-6 py-3.5 sm:px-12 sm:py-5 bg-[#e51411] text-white rounded-[8px] font-black text-xs uppercase tracking-[0.25em] hover:bg-red-700 hover:-translate-y-1 transition-all shadow-xl">
