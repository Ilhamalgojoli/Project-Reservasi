<div class="flex flex-col gap-6">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-20 text-center">
                            <div class="flex flex-col items-center justify-center opacity-20 grayscale">
                                ...
                                <p class="text-xs font-black uppercase mt-4 tracking-widest leading-none">Belum ada data peminjaman</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
    ...
    {{-- Pagination Card --}}
    <div class="{{ !$peminjaman->hasPages() ? 'hidden' : 'block' }} bg-white rounded-[8px] shadow-md border border-gray-100 px-5 py-3">
