<div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-5">
    ...
    <div class="relative overflow-hidden group" wire:ignore>
        <div id="map" class="h-[300px] w-full bg-gray-100 rounded-xl border border-gray-200 shadow-inner group-hover:border-blue-200 transition-colors duration-500"></div>
        
        {{-- Map Overlay Decorations --}}
        <div class="absolute bottom-4 left-4 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            <div class="px-3 py-1.5 bg-white/90 backdrop-blur-sm rounded-lg shadow-xl border border-white/50 text-[10px] font-bold text-gray-500 flex items-center gap-2">
