                ...
                <tr class="text-black hover:bg-gray-50/50 transition-colors border-black">
                    ...
                    <td class="px-4 py-4 text-center border-black">
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <span class="font-bold text-gray-800">{{ $data->nama_gedung ?? '-' }} / Lt.
                                {{ $data->lantai ?? '-' }}</span>
                        </div>
                    </td>
                    <td class="px-4 py-4 text-center border-black">
                    ...
                    <td class="px-4 py-4 text-center border-black">
                        <span
                            class="uppercase text-[11px] font-bold text-gray-400 tracking-widest">{{ $data->jenis_peminjaman }}</span>
                    </td>
                    <td class="px-4 py-4 text-center border-black">
                    ...
                    <td class="px-4 py-4 text-center border-black">
                        <div class="flex flex-col items-center gap-1">
                            ...
                            <span class="text-xs text-gray-400 font-semibold">{{ $data->jam_mulai }} –
                    ...
                    <td class="px-4 py-4 text-center border-black">
                        <div class="max-w-[200px] mx-auto">
                            <p class="text-xs text-gray-500 italic font-medium truncate"
                    ...
                    <td class="px-4 py-4 text-center border-black">
                        ...
                        <div class="flex items-center justify-center">
                            <span
                                class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-extrabold border {{ $badgeColor }}">
