...
@section('content')
        ...
        <div class="bg-[#ffffff] text-black rounded-xl py-1 px-1
            ...
            <div class="flex flex-col justify-center items-center gap-5 mb-2">
                ...
                <div class="flex flex-row gap-4">
                    <div class="bg-[#FF0101] px-3.5 py-2 rounded-md flex flex-col justify-center items-center">
                    ...
                    <div class="bg-[#FF0101] px-5 py-2 rounded-md flex flex-col justify-center items-center">
                        <h1 class="text-white text-2xl">30</h1>
                        <p class="text-white font-bold text-sm">Jumlah</p>
    ...
    <section id="pop-up-gedung" class="hidden fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
        <div class="bg-white p-6 rounded-xl shadow-lg
                overflow-y-auto relative flex-col w-[90%] sm:w-[80%] md:w-[600px] lg:w-[700px]">
            ...
            <div class="flex sm:flex-col md:flex-col lg:flex-col gap-5 w-full">
                <div class="flex flex-col gap-3">
                    <label for="gambar" class="rounded-lg py-2 px-3 border border-[#808080] border-opacity-50 text-[#808080] font-extrabold cursor-pointer">
                ...
                <div class="flex sm:flex-col md:flex-col lg:flex-row gap-5 mb-5">
                    <div class="flex flex-col gap-5 flex-1">
                        <input type="text"
                          ...
                          border-[#808080] border-opacity-50 font-extrabold"
                    ...
                    <div class="flex flex-col gap-5 flex-1">
                        <input type="text"
                            ...
                            border-opacity-50 font-extrabold"
                            placeholder="Jumlah Lantai " />
                        <select
                            class="rounded-xl sm:w-auto text-[#808080] py-2 px-3 appearance-none 
                        bg-transparent border border-[#808080] border-opacity-50 font-extrabold">
