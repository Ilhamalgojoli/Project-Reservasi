...
@section('content')
    ...
    <main class="grid sm:grid-cols-1 md:grid-cols-1">
        <!-- Section One -->
        <section class="grid grid-cols-2 lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-12 gap-5 justify-between mb-5">
            ...
            <div class="col-span-1 md:col-span-2 bg-white shadow-md p-5 rounded-[8px]">
                ...
                <div class="flex items-center justify-center">
                    <button data-popup-target="popup-tambah" class="bg-[#ff0000ce] rounded-lg px-5 py-2 font-bold">
                        Tambah Ruangan +
                    </button>
                </div>
            </div>
