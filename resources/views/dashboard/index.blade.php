    ...
    <div class="flex flex-col space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
            <div class="card-body col-span-12 bg-white rounded-xl p-8 shadow-lg space-y-4">
                <h1 class="text-2xl" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">Jadwal Akademik</h1>
                <div class="overflow-x-auto">
                    <table id="selection-table-1" class="table bordered-table sm-table mb-0 table-auto">
                        <thead>
                        <tr>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
            <div class="card-body col-span-12 bg-white rounded-xl p-8 shadow-lg space-y-4">
                <h1 class="text-2xl" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">Jadwal Non-Akademik</h1>
                <div class="overflow-x-auto">
