...
@section('content')
    ...
    <main class="grid grid-cols-1 md:grid-cols-4 sm:grid-cols-4 gap-6">
        <section class="col-span-12 bg-white p-10 rounded-2xl shadow-lg">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-1 gap-10">
                    <div class="flex flex-row gap-10 sm:gap-5 sm:flex-col md:flex-col lg:flex-row">
                        <div class="flex flex-col flex-1 gap-5">
                            ...
                            <input class="py-2 rounded-xl border-[#ebebeb]" type="text" />
                        </div>
                        <div class="flex flex-col flex-1 gap-5">
